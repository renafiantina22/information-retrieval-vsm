...
Processed Query:
['vector', 'space', 'model', 'inform', 'retriev']

Query TF:
{'vector': 1.0, 'space': 1.0, 'model': 1.0, 'inform': 1.0, 'retriev': 1.0}

Query TF-IDF:
{'vector': 0.9162907318741551, 'space': 0.9162907318741551, 'model': 0.9162907318741551, 'inform': 1.6094379124341003, 'retriev': 1.6094379124341003}
...
Hasil tersebut menunjukkan bahwa `doc1.txt` merupakan dokumen yang paling relevan terhadap query karena memiliki nilai cosine similarity tertinggi.